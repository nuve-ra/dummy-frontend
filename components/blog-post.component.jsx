    ...
    return(
        <Link to={`/blog/${id}`} className="flex gap-8 items-center border-b border-grey pb-5 mb-4">
            <div className="w-full">
                <div className="flex gap-2 items-left mb-7">
                    <img src = {profile_img} className="w-6 h-6 rounded-full" />
                    <p className="line-clamp-1"> {fullname}  @{username} {getDay(publishedAt)} </p>
            ...
            <div className="h-28 aspect-square bg-grey">
                <img src={banner} className="h-full w-full aspect-square object-cover"/>
